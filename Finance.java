...
public class Finance extends sales {//2.1 Inheritance & 2.5 Interface
	...
	public Finance(String name, String service, int price, int time, int person, int income, int spending, int profit, int tprice){//Constructor with nine arguments		
